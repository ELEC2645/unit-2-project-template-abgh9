...
/* Accept both "gray" and "grey", and "purple" as "violet" */
...
/* Returns digit 0-9, or -1 if invalid */
...
/* Returns exponent for multiplier (10^exp). Supports gold/silver negative exponents. */
